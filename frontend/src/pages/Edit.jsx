...
const InputField = ({ label, icon: Icon, type = "text", value, onChange, placeholder, min }) => (
  <div className="flex flex-col gap-2">
    ...
    <div className="flex items-center gap-3 bg-[#0f0f11] border border-white/10 rounded-2xl px-4 py-3 focus-within:border-white/30 transition-all duration-200">
...
const Edit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `${API_URL}/api/event/update-event/${id}`,
        form,
        { withCredentials: true }
      );
      navigate("/Events");
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">Update the details of your event.</p>
            </div>
          </div>
        </div>
